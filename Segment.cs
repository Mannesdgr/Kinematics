...
public class Segment : MonoBehaviour
{
    ...
    public void Follow(Transform target)
    {
        ...
        {
            /*
             * To find the position the segment needs to move towards we can subtract the length of the segment over the segment's forward axis from the target's position.
             */
